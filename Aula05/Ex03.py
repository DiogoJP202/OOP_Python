# Exercício 3: Herança 
# Crie a classe Imovel, que possui um endereço e um preço. Crie a classe ImovelNovo, que herda de Imovel e possui um adicional no preço. Crie a classe ImovelVelho, que herda de Imovel e possui um desconto no preço. O método calcular_preco das classes deve retornar o preço atualizado de acordo com o adicional ou desconto.
